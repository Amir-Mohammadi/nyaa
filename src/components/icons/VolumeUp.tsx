...
export type VolumeUpProps = Props;
const VolumeUp: React.FC<VolumeUpProps> = (props) => {
  return (
    <Svg viewBox="0 0 76.02 76.02" width={props.size} height={props.size}>
      ...
      <G id="prefix__Layer_2" data-name="Layer 2">
        <G id="prefix__Layer_1-2" data-name="Layer 1">
          ...
          <Path
            fill={props.color}
            d="M70.75 39.47H50.24a1.47 1.47 0 110-2.93h20.51a1.47 1.47 0 110 2.93z"
          />
          <Path
            fill={props.color}
            d="M62 27.75v20.52a1.47 1.47 0 01-2.93 0V27.75a1.47 1.47 0 012.93 0z"
          />
        </G>
      </G>
    </Svg>
